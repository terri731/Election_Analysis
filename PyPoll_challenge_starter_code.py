...
# file_to_load = "C:\Users\terri\Google Drive\Vanderbilt\Module3\Challenges\03-PyPoll\Election_Analysis\Resources\election_results.csv"

# Add a variable to save the file to a path.
file_to_save = os.path.join (dir_path, "election_analysis.txt")
...
with open(file_to_save, "w") as txt_file:
    ...
    for county in county_votes_dict:
        ...
        county_vote = county_votes_dict[county]
        # 6c: Calculate the percentage of votes for the county.
        county_percentage = float(county_vote/total_votes * 100)

         # 6d: Print the county results to the terminal.
        county_results = (
            f"{county}: has {county_percentage:.1f}% ({county_vote:,}) \n")
